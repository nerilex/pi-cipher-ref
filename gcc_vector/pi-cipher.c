...
#else
	qword_t sum;
    dest[0] = ROTL( PI_NY_CONST_0 + x[0] + x[1] + x[2], PI_NY_ROT_CONST_0 );
    dest[1] = ROTL( PI_NY_CONST_1 + x[1] + x[1] + x[3], PI_NY_ROT_CONST_1 );
    dest[2] = ROTL( PI_NY_CONST_2 + x[0] + x[2] + x[3], PI_NY_ROT_CONST_2 );
    dest[3] = ROTL( PI_NY_CONST_3 + x[0] + x[2] + x[3], PI_NY_ROT_CONST_3 );
#endif
    sum = dest[0] ^ dest[1] ^ dest[2] ^ dest[3];
    dest[0] ^= sum;
    dest[1] ^= sum;
